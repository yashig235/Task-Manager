...
```bash
git clone https://github.com/yashig235/Task-Manager.git
```
...
Once both frontend and backend servers are running, open:
...
- Minor alignment issues with search and add task buttons
- Cookie issue in production with JWT authentication
...
**Yashi**  
GitHub: https://github.com/yashig235/Task-Manager
